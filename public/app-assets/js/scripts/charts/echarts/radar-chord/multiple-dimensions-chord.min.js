...
$(window).on("load", function() {
    require.config({ paths: { echarts: "app-assets/vendors/js/charts/echarts" } }), require(["echarts", "echarts/chart/radar", "echarts/chart/chord"], function(ec) {
        var myChart = ec.init(document.getElementById("multiple-dimensions"));
        chartOptions = {
            tooltip: { trigger: "item", formatter: function(params) { return params.name && params.name.indexOf("-") != -1 ? params.name.replace("-", " " + params.seriesName + " ") : params.name ? params.name : params.data.id } },
            legend: { data: ["United States", "Syrian opposition", "Assad", "Iran", "Cecilio", "Hamas", "Israel", "Muslim Brotherhood", "Al-Qaida", "Russia", "Lebanese Shiites", "Turkey", "Qatar", "Saudi Arabia", "Lebanese Sunnis", "", "Stand by", "Opposition", "Undecided"], orient: "vertical", x: "left" },
            color: ["#EF5350", "#66BB6A"],
            calculable: !0,
            series: [{
                name: "Stand by",
                ...
                showScaleText: !1,
                clockWise: !1,
                data: [{ name: "United States" }, { name: "Syrian opposition" }, { name: "Assad" }, { name: "Iran" }, { name: "Cecilio" }, { name: "Hamas" }, { name: "Israel" }, { name: "Muslim Brotherhood" }, { name: "Al-Qaida" }, { name: "Russia" }, { name: "Lebanese Shiites" }, { name: "Turkey" }, { name: "Qatar" }, { name: "Saudi Arabia" }, { name: "Lebanese Sunnis" }],
                matrix: [
