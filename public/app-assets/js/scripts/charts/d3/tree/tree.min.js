...
$(window).on("load", function() {
    ...
    d3.json("app-assets/data/d3/tree/tree.json", function(error, json) {
        ...
        var nodes = tree.nodes(json),
            ...
            nodeGroup = (linkGroup.selectAll(".d3-tree-link").data(links).enter().append("path").attr("class", "d3-tree-link").attr("d", diagonal).style("fill", "none").style("stroke", "#e3e3e3").style("stroke-width", 1.5), svg.append("g").attr("class", "d3-tree-node-group")),
