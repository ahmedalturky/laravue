...
$(window).on("load", function() {
    ...
    var ele = d3.select("#bar-chart"),
        ...
        tip = d3.tip().attr("class", "d3-tip").offset([-10, 0]).html(function(d) { return "<strong>Frequency:</strong> <span style='color:#FF847C'>" + d.frequency + "</span>" }),
