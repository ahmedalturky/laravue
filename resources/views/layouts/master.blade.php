        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item">
            <a class="navbar-brand" href="index.html">
              <img class="brand-logo" style="border-radius: 50%;width:50px;height: 50px;" alt="modern admin logo" src="img/logo-o.jpeg" >
              <h3 class="brand-text">أوبتيزون للبصريات</h3>
            </a>
          </li>
            ...
            <!-- <li class="dropdown dropdown-user nav-item"> -->
              <a class="dropdown-toggle nav-link dropdown-user-link"  data-toggle="dropdown">
                ...
                document.getElementById('logout-form').submit();">
                                    <span class="avatar">
                <img src="/img/power.png" alt="avatar">     </span>
                </a>
